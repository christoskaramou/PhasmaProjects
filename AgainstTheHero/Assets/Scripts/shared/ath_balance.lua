...
Balance.monsters = {
    ...
    corn_colossus = { base = "corn_mortar", name = "Corn Colossus", threat_cost = 20, hp = 1835, dps = 30.0,
        ...
        unset = { "tactical_role" } },
    -- Sprite-first boss roster. These inherit one of the three proven combat
    -- shells until each signature mechanic replaces that shell in its own pass.
    briar_matriarch = { base = "gourd_king", name = "Briar Matriarch", threat_cost = 20,
        hp = 3000, dps = 26.0, scale = 2.35,
        tint = { 1.0, 1.0, 1.0 },
        sprite_sheet = "Textures/modes/arena/creeps/briar_matriarch/briar_matriarch.sprite.json" },
    bog_cantor = { base = "corn_colossus", name = "Bog Cantor", threat_cost = 20,
        hp = 1835, dps = 30.0, scale = 2.35,
        tint = { 1.0, 1.0, 1.0 },
        sprite_sheet = "Textures/modes/arena/creeps/bog_cantor/bog_cantor.sprite.json" },
    millwright_spectre = { base = "gourd_king", name = "Millwright Spectre", threat_cost = 20,
        hp = 3000, dps = 26.0, scale = 2.45,
        tint = { 1.0, 1.0, 1.0 },
        sprite_sheet = "Textures/modes/arena/creeps/millwright_spectre/millwright_spectre.sprite.json" },
    fox = { base = "wasp_queen", name = "The Fox", threat_cost = 20,
        hp = 2840, dps = 24.0, scale = 2.85,
        tint = { 1.0, 1.0, 1.0 },
        sprite_sheet = "Textures/modes/arena/creeps/fox/fox.sprite.json" },
    feast_warden = { base = "gourd_king", name = "Feast Warden", threat_cost = 20,
        hp = 3000, dps = 26.0, scale = 2.5,
        tint = { 1.0, 1.0, 1.0 },
        sprite_sheet = "Textures/modes/arena/creeps/feast_warden/feast_warden.sprite.json" },
    weathervane_horror = { base = "wasp_queen", name = "Weathervane Horror", threat_cost = 20,
        hp = 2840, dps = 24.0, scale = 2.7,
        tint = { 1.0, 1.0, 1.0 },
        sprite_sheet = "Textures/modes/arena/creeps/weathervane_horror/weathervane_horror.sprite.json" },
    pale_scarecrow = { base = "gourd_king", name = "Pale Scarecrow", threat_cost = 20,
        hp = 3000, dps = 26.0, scale = 2.7,
        tint = { 1.0, 1.0, 1.0 },
        sprite_sheet = "Textures/modes/arena/creeps/pale_scarecrow/pale_scarecrow.sprite.json" },
    wyrmroot_ascetic = { base = "corn_colossus", name = "Wyrmroot Ascetic", threat_cost = 20,
        hp = 1835, dps = 30.0, scale = 2.45,
        tint = { 1.0, 1.0, 1.0 },
        sprite_sheet = "Textures/modes/arena/creeps/wyrmroot_ascetic/wyrmroot_ascetic.sprite.json" },
    corn_court_herald = { base = "corn_colossus", name = "Corn Court Herald", threat_cost = 20,
        hp = 1835, dps = 30.0, scale = 2.5,
        tint = { 1.0, 1.0, 1.0 },
        sprite_sheet = "Textures/modes/arena/creeps/corn_court_herald/corn_court_herald.sprite.json" },
    king_of_ovrevand = { base = "gourd_king", name = "King of Ovrevand", threat_cost = 20,
        hp = 3000, dps = 26.0, scale = 2.75,
        tint = { 1.0, 1.0, 1.0 },
        sprite_sheet = "Textures/modes/arena/creeps/king_of_ovrevand/king_of_ovrevand.sprite.json" },
