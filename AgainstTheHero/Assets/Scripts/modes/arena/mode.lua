...
return {
    ...
    config = {
        ...
        prewarm = { sprout = 18, popcorn_kernel = 4, husk_knight = 6, pumpkin_brute = 2, crow = 4, seed_spitter = 4, beetle = 8, corn_mortar = 2, wasp = 5, ram_beetle = 2, blast_bud = 2, thorn_guard = 2, spore_witch = 2, brood_pod = 1,
